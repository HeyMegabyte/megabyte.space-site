...
export class TermsServicePage {
  ...
  render() {
    ...
    return (
      <Host>
        <meta-tags
          page-title="Terms of Service | Megabyte Labs"
          description={'Megabyte Labs Terms of Service'}
        />
        <Telemetry />
    ...
    <ResponsiveContainer id="terms-service" as="section">
      ...
      <ul>
        ...
        distribute any content that:
            ...
            <li>iiii. Impersonates any person or entity, including any https://megabyte.space employees or representatives.</li>
          </ul>
        </li>
      </ul>
      ...
      <Paragraph>All content and materials available on https://megabyte.space, including but not limited to text, graphics, website
      ...
      <div class="contact-info">
        <div class="contact-detail">
          ...
          <div class="contact-text">
            <a class="underline-hover" href="https://megabyte.space">https://megabyte.space</a>
          </div>
        </div>
        <div class="contact-detail">
          <div class="contact-icon">
