...
export class TermsServicePage {
  ...
  TermsService = () => (
    <ResponsiveContainer id="terms-service" as="section">
      ...
      <Paragraph>All content and materials available on <a href="https://megabyte.space">https://megabyte.space</a>, including but not limited to text, graphics, website
