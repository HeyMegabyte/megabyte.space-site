...
export class TermsServicePage {
  ...
  TermsService = () => (
    <ResponsiveContainer id="terms-service" as="section">
      ...
      <Paragraph>
        This website is owned and operated by <a {...href('/')}>Megabyte LLC</a> (also referred to as Megabyte Labs). By visiting our website and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as 'User Agreement'), along with the terms and conditions as stated in our Privacy Policy (please refer to the Privacy Policy section below for more information).
      </Paragraph>
      ...
      <ul>
        ...
        <li>g. We may provide various open communication tools on our website, such as blog comments, blog posts, public chat,
          ...
          <ul>
            ...
            <li>iiii. Impersonates any person or entity, including any <a {...href('/')}>https://megabyte.space</a> employees or representatives.</li>
          </ul>
        </li>
      </ul>
      ...
      <Paragraph>All content and materials available on <a {...href('/')}>https://megabyte.space</a>, including but not limited to text, graphics, website
      ...
      <div class="contact-info">
        <div class="contact-detail">
          ...
          <div class="contact-text">
            <a class="underline-hover" {...href('/')}>https://megabyte.space</a>
          </div>
        </div>
        <div class="contact-detail">
          <div class="contact-icon">
