      ...
      <ResponsiveContainer id="getting-started" as="section">
        <article class="step">
          ...
          <div class="heading-group">
            ...
            <Paragraph>
              <a href="https://github.com/megabyte-labs/gas-station" target="_blank">Gas Station</a> is the predecessor to <a href="https://install.doctor" target="_blank">Install Doctor</a>. It is a massive Ansible project that can be used to provision both workstations and servers. To support its development, many unique features were included, namely <a href="https://github.com/megabyte-labs/ansibler" target="_blank">Ansibler</a> and <a href="https://github.com/megabyte-labs/mod-ansible-autodoc" target="_blank">Ansible Auto-Documentation</a>.
            </Paragraph>
          </div>
        ...
        <article class="step">
          ...
          <div class="heading-group">
            ...
            <Paragraph>
              During the development of Gas Station, hundreds of Ansible roles were created. The roles support the same targets that Install Doctor does - Arch Linux, CentOS, Debian, Fedora, macOS, Qubes, and Windows. To view all of the roles, browse through the roles folder of the <a href="https://github.com/megabyte-labs/gas-station" target="_blank">Gas Station</a> project. Many of the roles are available on <a href="https://galaxy.ansible.com/search?deprecated=false&keywords=professormanhattan&order_by=-relevance&page=1" target="_blank">Ansible Galaxy</a>.
            </Paragraph>
          </div>
          <div class="image-wrapper">
            <img
